...
public class FileHelper {
    ...
    public static String FOLDER_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/facerecognition";
    public static String TRAINING_PATH = FOLDER_PATH + "/training/";
    public static String TEST_PATH = FOLDER_PATH + "/test/";
    public static String DETECTION_TEST_PATH = FOLDER_PATH + "/detection_test/";
    public static String DATA_PATH = FOLDER_PATH + "/data/";
    public static String RESULTS_PATH = FOLDER_PATH + "/results/";
    public static String EIGENFACES_PATH = DATA_PATH + "Eigenfaces/";
    public static String SVM_PATH = DATA_PATH + "SVM/";
    public static String KNN_PATH = DATA_PATH + "KNN/";
    public static String CAFFE_PATH = DATA_PATH + "Caffe/";
    public static String TENSORFLOW_PATH = DATA_PATH + "TensorFlow/";
    private static String SEPARATOR = ";";

    public static void initDirectory() {
        TRAINING_PATH = FOLDER_PATH + "/training/";
        TEST_PATH = FOLDER_PATH + "/test/";
        DETECTION_TEST_PATH = FOLDER_PATH + "/detection_test/";
        DATA_PATH = FOLDER_PATH + "/data/";
        RESULTS_PATH = FOLDER_PATH + "/results/";
        EIGENFACES_PATH = DATA_PATH + "Eigenfaces/";
        SVM_PATH = DATA_PATH + "SVM/";
        KNN_PATH = DATA_PATH + "KNN/";
        CAFFE_PATH = DATA_PATH + "Caffe/";
        TENSORFLOW_PATH = DATA_PATH + "TensorFlow/";
    }
    ...
    public void saveStringList(List<String> list, File file) {
        try {
            ...
            File file1 = new File(SVM_PATH + "svm_train");
            if (!file1.exists()) {
                Log.e("inside", "savestringlist");
                FileWriter fw1 = new FileWriter(file, true);
                BufferedReader br = new BufferedReader(new FileReader(SVM_PATH + "extra_data"));
                String lines;
            ...
            fw.close();
            persons = getTrainingList();
            if (persons.length > 0) {
                for (File person : persons) {
                    String[] entries = person.list();
                    for (String s : entries) {
                        File currentFile = new File(person.getPath(), s);
                        currentFile.delete();
                    }
                    person.delete();
                }
    ...
    public void deleteTrainingDirectory() {
        deleteRecursive(new File(TRAINING_PATH));
    }
